...
export abstract class SaftlimacherBaseGameComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy() {
    ...
    // TODO: listeners vervollständigen, sortieren..
  ...
  private buildGameView(levelData): void {
    ...
    setTimeout(() => {
      ...
      // this.startGameScene(this.config, this.socketService, levelData);
...
// export default class SaftlimacherBaseScene extends Phaser.Scene {
